...
# Select variables that are going to be analysed in this set
...
pheno <- pheno %>%
  select(NGS_ID,
         Participant_ID,
         Site,
         IfyeswhichonDog.u3s_u1a,
         Cat.u3s_u1b,
         Rodent.u3s_u1d,
         Other.u3s_u1e,
         IydnhyopDyhcwoppsafofm.u3s_u3,
         HmhaddysoaoecwsgMisdh.u3s_t2a,
         MndyFrdyinwntdh.u3s_t2b,
         StrdySndyinsmdh.u3s_t2c,
         StrdySndyinwndh.u3s_t2d,
         Hodyusiasiscsis.u3s_t3a,
         WdysmoyftoowodoBL.u3s_t4a1,
         green.spaces.u3s_t4a2,
         Urban.spaces.u3s_t4a3,
         mountain.region.u3s_t4a4,
         onholidaybechlk.u3s_t4b1,
         green.spaces.u3s_t4b2,
         Urban.spaces.u3s_t4b3,
         mountain.region.u3s_t4b4,
         Agetothedeadlin.u3talter,
         gender.u3csex,
         marital.status.u3tfamstd,
         HVQvfS4sLTBERUF.u3tberufb,
         LBoGRIfGDD31201.u3tortgc,
         BMI.u3tbmi,
         wash,
         cream)
pheno.dic <- pheno.dic %>% 
