...
comb.pheno <- bind_rows(in.kora.pheno %>% 
  ...
  mutate(Antibiotics...6m. = if_else(is.na(Antibiotics...6m.),
                                     "NA",
                                     Antibiotics...6m.),
         Sport.in.summer..h.week. = if_else(is.na(Sport.in.summer..h.week.),
                                            0,
...
our_summary1 <- list(
  ...
  "Systemic antibiotics" = list("Antibiotics (< 6-8w):yes" = ~ n_perc0(.data$Antibiotics...6.8w. == "yes"),
                                "Antibiotics (< 6m)*:do not know" = ~ n_perc0(.data$Antibiotics...6m. == "do not know"),
                                "Antibiotics (< 6m)*:no" = ~ n_perc0(.data$Antibiotics...6m. == "no"),
                                "Antibiotics (< 6m)*:yes" = ~ n_perc0(.data$Antibiotics...6m. == "yes")),
