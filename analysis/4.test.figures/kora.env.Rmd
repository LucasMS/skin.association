...
ggplot(this.plot,
  ...
  geom_errorbar(data = this.plot %>% 
               filter(Subgroup == "UV prot."), aes(xmin=value-se, xmax=value+se, color = Description),  width=.1) +
  ...
  geom_point(data = this.plot %>% 
    ...
    geom_errorbar(data = this.plot %>% 
               filter(Subgroup == "Hours\noutdoors"), aes(xmin=value-se, xmax=value+se, color = Description),  width=.1) +
  labs(color = "Hours\noutdoors") +
  new_scale("color") +
  # Education
  geom_point(data = this.plot %>% 
  ...
  labs(color = "Education") +
    geom_errorbar(data = this.plot %>% 
               filter(Subgroup == "Education"), aes(xmin=value-se, xmax=value+se, color = Description),  width=.1) +
  new_scale("color") +
  # Dwelling
  geom_point(data = this.plot %>% 
  ...
  labs(color = "Dwelling") +
    geom_errorbar(data = this.plot %>% 
               filter(Subgroup == "Dwelling"), aes(xmin=value-se, xmax=value+se, color = Description),  width=.1) +
  new_scale("color") +
  ...
  geom_errorbar(data = this.plot %>% 
               filter(Subgroup == "Animal\ncontact"), aes(xmin=value-se, xmax=value+se, color = Description),  width=.1) +
  new_scale("color") +
  theme(legend.position = "right") +
