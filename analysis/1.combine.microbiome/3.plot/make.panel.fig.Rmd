...
# Add sharedness
gshare <- "~/IKMB/projects/skin.associations/results/analysis/1.combine.microbiome/0.sharedness/shared.rds" %>% 
  readRDS()
```
...
gab <- ggpubr::ggarrange(g.tax, g.roc, ncol =2, labels = "AUTO", widths = c(1.5,1))
gcd <- ggpubr::ggarrange(g.mds, gshare, ncol= 2, labels = c("C", "D"), widths = c(1, 0.8))
ggpubr::ggarrange(gab,gcd, nrow = 2, heights = c(0.5,1))
```
